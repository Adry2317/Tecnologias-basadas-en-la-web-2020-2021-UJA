...
<body>
    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="" href="<?php echo base_url("pages/logAdminPrincipal") ?>">Inicio</a></li>
          <li><a href="<?php echo base_url("pages/logInstalaciones") ?>">Instalaciones</a></li>
          <li><a href="<?php echo base_url("Actividades/logAdminActividades") ?>">Actividades</a></li>
          <li><a href="<?php echo base_url("Gestiones/vista") ?>">Gestiones</a></li>
          <li><a href="<?php echo base_url("usuariosAdmin/logAdminUsuarios") ?>">Usuarios</a></li>
          <li><a href="<?php echo base_url("pages/logAdminContacto") ?>">Contacto</a></li>
