...
<body>
	...
	<?php
		$row = $actividad;
		echo "<h1>Modificar actividad</h1>" .

		
        form_open('Actividades/datos',['name'=>'formAct']) .
                  
                
                  "<div class='form-group'>
                      <label for='imputNombre'>Nombre actividad</label>
                      <input type='text' class='form-control' name='imputNombre' placeholder='Nombre actividad' value='".$row->Nombre."'>
                  </div>
                  <br>
                  <br>
                  <div class='form-group' style='display: none'>
                      <label for='imputNombre'>Nombre actividad</label>
                      <input type='text' class='form-control' name='ident' placeholder='Nombre actividad' value='".$row -> id_actividad ."'>
                  </div>
                  <br>
                  ...
                  <fieldset class='form-group'>
                      <div class='row'>
                        ...
                        <div class='col-sm-10'>
                            <input type='time' id='start' name='horaini' value='". $row -> Hora_inicio."'>
                        </div>
                      </div>
                  </fieldset>
                  <br>
                  ...
                  <fieldset class='form-group'>
                      <div class='row'>
                        ...
                        <div class='col-sm-10'>
                            <input type='time' id='start' name='horafin' value='". $row -> Hora_fin."'>
                        </div>
                      </div>
                  </fieldset>
                  <br>
                  ...
                  <div class='form-group'>
                      ...
                      <input type='number'  name='plazas' value='".$row -> plazas."'>
